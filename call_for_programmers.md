...
The [Zine Union Catalog](www.zinecat.org) (aka ZineCat or ZUC) is in need of a website developer to make a professional, static site, that details the activity of the Zine Union Catalog and provide clear information about the project and its creators.  The site will be created using HTML and CSS and will require working closely with the client (creators of ZineCat) to develop content , design, and build the site.  

The following are the pages required in phase one of website development:
* Home Page
* About Us
